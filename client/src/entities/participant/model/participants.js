export const initialParticipantsState = Object.freeze({
  byId: {},
  order: [],
  selfId: null,
});
  ...
  switch (action.type) {
    ...
    case "left": {
      ...
      return {
        ...state,
        byId,
        order: state.order.filter((id) => id !== action.participantId),
        selfId: state.selfId === action.participantId ? null : state.selfId,
      };
    }
    default:
      return state;
